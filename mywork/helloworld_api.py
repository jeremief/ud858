...
REQUEST_GREETING_CONTAINER = endpoints.ResourceContainer( # Adding this container for the greeting by period) 
    message_types.VoidMessage,
...
class HelloWorldApi(remote.Service):
    ...
    @endpoints.method(REQUEST_GREETING_CONTAINER, Hello, #Adding this method for the greeeting by period
      path="sayHelloByPeriod", http_method='GET', name='greetByPeriod') # the name on this line is the one that is actually used to access the api
